...
from C_models.StarE.models import Transformer_Baseline, StarE_ConvKB_Statement, StarE_Transformer_Triples
from C_models.StarE.models_statements import StarE_Transformer_TripleBaseline, Transformer_Statements, \
    StarE_ObjectMask_Transformer, StarE_Transformer
...
if __name__ == "__main__":
    ...
    print(f"Training on {n_entities-1} entities / {n_relations-1} relations")
    ...
    # Saving stuff
    if config['SAVE']:
        savedir = Path(f"./D_export/models/{config['DATASET']}/{config['MODEL_NAME']}")
